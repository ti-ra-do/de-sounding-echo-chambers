...
class Evaluator:
    def __init__(self, name, eval_metric):
        self.name = name
    ...
    def _parse_and_check_input(self, input_dict):
        if 'hits@' in self.eval_metric:
            ...
            # check the intermediate tyep of y_pred_pos
            ...
            # check the intermediate type of y_pred_neg
    ...
    def _eval_mrr(self, y_pred_pos, y_pred_neg, type_info):
        ...
        if type_info == 'torch':
            ...
            #print(hits10_list)
            #print()
            return {'hits_at_1_list': hits1_list,
                    'hits_at_3_list': hits3_list,
                    'hits_at_10_list': hits10_list,
                    'mrr_list': mrr_list}
